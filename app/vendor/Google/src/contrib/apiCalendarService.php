...
require_once 'service/apiServiceRequest.php';
   ...
   *  </code>
   */
  class GEventsServiceResource extends apiServiceResource {
     ...
     *
     * @param string $calendarId Calendar identifier.
     * @param string $eventId GEvent identifier.
     * @param array $optParams Optional parameters. Valid optional parameters are listed below.
     *
     ...
     * @return GEvent
     */
    public function insert($calendarId, GEvent $postBody, $optParams = array()) {
      $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @opt_param bool singleGEvents Whether to expand recurring events into instances and only return single one-off events and instances of recurring events, but not the underlying recurring events themselves. Optional. The default is False.
     ...
     * @return GEvents
     */
    public function listGEvents($calendarId, $optParams = array()) {
      $params = array('calendarId' => $calendarId);
      $params = array_merge($params, $optParams);
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GEvents($data);
      } else {
        return $data;
      }
    }
     ...
     * @return GEvent
     */
    public function update($calendarId, $eventId, GEvent $postBody, $optParams = array()) {
     ...
     * @return GEvent
     */
    public function patch($calendarId, $eventId, GEvent $postBody, $optParams = array()) {
      $params = array('calendarId' => $calendarId, 'eventId' => $eventId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
     ...
     * @return GEvent
     */
    public function import($calendarId, GEvent $postBody, $optParams = array()) {
      $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
...
class CalendarListEntry extends apiModel {
  public $kind;
  protected $__defaultRemindersType = 'GEventReminder';
  ...
  public function setDefaultReminders(/* array(GEventReminder) */ $defaultReminders) {
    $this->assertIsArray($defaultReminders, 'GEventReminder', __METHOD__);
...
class Colors extends apiModel {
  ...
  public function setGEvent(ColorDefinition $event) {
    $this->event = $event;
  }
  public function getGEvent() {
    return $this->event;
  }
  public function setKind($kind) {
    $this->kind = $kind;
...
class GGError extends apiModel {
  public $domain;
  public $reason;
...
class GEvent extends apiModel {
  protected $__creatorType = 'GEventCreator';
  protected $__creatorDataType = '';
  public $creator;
  protected $__organizerType = 'GEventOrganizer';
  protected $__organizerDataType = '';
  public $organizer;
  public $id;
  protected $__attendeesType = 'GEventAttendee';
  protected $__attendeesDataType = 'array';
  public $attendees;
  public $htmlLink;
  public $recurrence;
  protected $__startType = 'GEventDateTime';
  protected $__startDataType = '';
  public $start;
  public $etag;
  public $location;
  public $recurringGEventId;
  protected $__originalStartTimeType = 'GEventDateTime';
  protected $__originalStartTimeDataType = '';
  public $originalStartTime;
  public $status;
  public $updated;
  protected $__gadgetType = 'GEventGadget';
  protected $__gadgetDataType = '';
  public $gadget;
  public $description;
  public $iCalUID;
  protected $__extendedPropertiesType = 'GEventExtendedProperties';
  protected $__extendedPropertiesDataType = '';
  public $extendedProperties;
  public $sequence;
  public $visibility;
  public $guestsCanModify;
  protected $__endType = 'GEventDateTime';
  ...
  protected $__remindersType = 'GEventReminders';
  ...
  public $transparency;
  public $privateCopy;
  public function setCreator(GEventCreator $creator) {
    $this->creator = $creator;
  }
  public function getCreator() {
    return $this->creator;
  }
  public function setOrganizer(GEventOrganizer $organizer) {
  ...
  public function setAttendees(/* array(GEventAttendee) */ $attendees) {
    $this->assertIsArray($attendees, 'GEventAttendee', __METHOD__);
  ...
  public function setStart(GEventDateTime $start) {
    $this->start = $start;
  }
  ...
  public function setRecurringGEventId($recurringEventId) {
    $this->recurringGEventId = $recurringEventId;
  }
  public function getRecurringGEventId() {
    return $this->recurringGEventId;
  }
  public function setOriginalStartTime(GEventDateTime $originalStartTime) {
  ...
  public function setGadget(GEventGadget $gadget) {
    $this->gadget = $gadget;
  }
  ...
  public function setExtendedProperties(GEventExtendedProperties $extendedProperties) {
  ...
  public function setEnd(GEventDateTime $end) {
    $this->end = $end;
  }
  ...
  public function setReminders(GEventReminders $reminders) {
...
class GEventAttendee extends apiModel {
  public $comment;
  public $displayName;
  public $self;
...
class GEventCreator extends apiModel {
  public $displayName;
  public $email;
  public function setDisplayName($displayName) {
    $this->displayName = $displayName;
...
class GEventDateTime extends apiModel {
  public $date;
  public $timeZone;
  public $dateTime;
...
class GEventExtendedProperties extends apiModel {
  public $shared;
  public $private;
...
class GEventGadget extends apiModel {
  public $preferences;
  public $title;
  public $height;
  public $width;
...
class GEventOrganizer extends apiModel {
  public $displayName;
  public $email;
  public function setDisplayName($displayName) {
    $this->displayName = $displayName;
...
class GEventReminder extends apiModel {
  public $minutes;
  public $method;
...
class GEventReminders extends apiModel {
  protected $__overridesType = 'GEventReminder';
  protected $__overridesDataType = 'array';
  public $overrides;
  public $useDefault;
  public function setOverrides(/* array(GEventReminder) */ $overrides) {
    $this->assertIsArray($overrides, 'GEventReminder', __METHOD__);
...
class GEvents extends apiModel {
  public $nextPageToken;
  public $kind;
  protected $__defaultRemindersType = 'GEventReminder';
  protected $__defaultRemindersDataType = 'array';
  ...
  public function setItems(/* array(GEvent) */ $items) {
    $this->assertIsArray($items, 'GEvent', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class FreeBusyCalendar extends apiModel {
  ...
  public $busy;
  protected $__errorsType = 'GGError';
  ...
  public function setGErrors(/* array(GError) */ $errors) {
    $this->assertIsArray($errors, 'GGError', __METHOD__);
    $this->errors = $errors;
  }
