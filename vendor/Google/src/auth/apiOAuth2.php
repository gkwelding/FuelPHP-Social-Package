...
class apiOAuth2 extends apiAuth {
  ...
  public function authenticate($service) {
    if (isset($_GET['code'])) {
      ...
      if ($request->getResponseHttpCode() == 200) {
        ...
        throw new apiAuthException("GError fetching OAuth2 access token, message: '$response'", $request->getResponseHttpCode());
      }
    }
  ...
  public function refreshToken($refreshToken) {
    ...
    if ($code == 200) {
      ...
      throw new apiAuthException("GError refreshing the OAuth2 token, message: '$body'", $code);
    }
  }
