...
class TrainingModelInfo extends apiModel {
  ...
  public function setMeanSquaredGError($meanSquaredError) {
    $this->meanSquaredGError = $meanSquaredError;
  }
  public function getMeanSquaredGError() {
    return $this->meanSquaredGError;
  }
