...
require_once 'service/apiServiceRequest.php';
  ...
  class GEventsServiceResource extends apiServiceResource {
     ...
     * @return GEvents
     */
    public function listGEvents($role, $roleId, $optParams = array()) {
      $params = array('role' => $role, 'roleId' => $roleId);
      $params = array_merge($params, $optParams);
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
...
class CalGEvent extends apiModel {
  ...
  public $status;
  public $chargeId;
  protected $__productsType = 'GEventProducts';
  ...
  public function setProducts(/* array(GEventProducts) */ $products) {
    $this->assertIsArray($products, 'GEventProducts', __METHOD__);
  ...
  public function setGEventDate($eventDate) {
    $this->eventDate = $eventDate;
  }
  public function getGEventDate() {
    return $this->eventDate;
  }
}

class GEventProducts extends apiModel {
  protected $__networkFeeType = 'Money';
  protected $__networkFeeDataType = '';
  public $networkFee;
  public $sku;
...
class GEvents extends apiModel {
  public $nextPageToken;
  protected $__itemsType = 'CalGEvent';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setNextPageToken($nextPageToken) {
  ...
  public function setItems(/* array(CalGEvent) */ $items) {
    $this->assertIsArray($items, 'CalGEvent', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
